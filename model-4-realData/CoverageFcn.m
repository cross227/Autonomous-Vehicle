...
for i=1:noPoints
   ...
   [ coverage, pointsCount] = expand( thisX, thisY, thisRssi, coverage, pointsCount, expSize );

   if(i>milestone)
       disp(sprintf('%d %% concluded',ceil(i*100/noPoints)));
